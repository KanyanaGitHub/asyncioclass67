...
async def checkout_customer(queue: Queue, cashier_number: int):
    ...
    while not queue.empty():
        ...
        cashier_count += 1
        customer_total += round(time.perf_counter() - customer_start_time, ndigits=2)
        queue.task_done()

    return cashier_number, cashier_count, total_time, round(customer_total, ndigits=2)
...
# +--------|------------|-------------|-------------------------------------------------|-------+    
# Customer | Queue      | Cashier	  |            Customers/time by Cashier            | Tptal
#          |            |             | c |  1  | c |  2  | c |  3  | c |  4  | c |  5  |
# +--------|------------|-------------|---|-----|---|-----|---|-----|---|-----|---|-----|-------+
# 2	       | 2	        | 2		      | 1 |2.0s | 1 |2.0s |   |     |   |     |   |     | 2.01s       
# 3	       | 2	        | 2		      | 1 |2.0s | 1 |2.0s |   |     |   |     |   |     | 4.01s                                                    		
# 4	       | 2	        | 2		      | 2 |4.0s | 2 |4.0s |   |     |   |     |   |     | 4.01s                
# 5	       | 5	        | 5		      | 1 |2.0s | 1 |2.0s | 1 |2.0s | 1 |2.0s | 1 |2.0s | 2.01s                
# 10       | 3	        | 3			  | 3 |6.0s | 3 |6.0s | 3 |6.0s |   |     |   |     | 8.03s                   
# 10       | 3			| 5           | 3 |6.0s | 3 |6.0s | 3 |6.0s |   |     |   |     | 8.02s       
